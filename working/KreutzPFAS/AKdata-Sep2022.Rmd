...
# Get rid of column header rows:
  ...
  this.file.data$Analysis.Instrument <- "Mystery GCMS"
  this.file.data$Level0.File <- this.file
...
```{r format_and_annotate, eval=TRUE}
    ...
    level1 <- rbind(level1,level1.May2020,level1.Jul2020,level1.Dec2020)
...
```{r Bayes, eval=TRUE}
    ...
    library(invitroTKstats) 
    setwd("c:/users/jwambaug/git/invitroTKstats/working/KreutzPFAS/")
    level4 <- calc_fup_uc(FILENAME="KreutzPFAS",JAGS.PATH="C:/Users/jwambaug/AppData/Local/Programs/JAGS/JAGS-4.3.1/x64") 
```