---
  title: "Kreutz 2022 GC PFAS Ultracentrifugation Data"
...
```
```{r bad_sample_annotate, eval=TRUE}
...
```
Somethings weird with this chemicals data, clean up the odder samples:
```{r cleanup_DTXSID20335129, eval=TRUE}    
