...
## concentrations of compound other than 8:2 FTS are in nM, need to convert the unit to uM which is what the package uses
...
## Identify and remove mixes that do not match what should be used for the analyte 
