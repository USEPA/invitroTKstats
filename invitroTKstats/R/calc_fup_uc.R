...
# For a properly formatted level 2 file we should have all these columns:
  ...
  if (NUM.CORES > MAX.CORES) stop("Specified NUM.CORES cores for parallel computing exceeds the allowable number of cores, 
                                  that is MAX.CORES, and may bog down your machine! 
                                  (Max cores is based on the total number of available computing cores minus one for overhead.)")
