...
# input the Level 2 data and a selected DTXSID
# is returning two plots because the code do both print AND return
DTXSID <- unique(level2.uc$DTXSID)[2]
plot_fup_uc(level2.uc, DTXSID)
```
