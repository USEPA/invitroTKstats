...
`calc_fup_red` is the Level 3 function used to calculate the f~up~ RED point estimate for each test compound using a Frequentist framework. 

Mathematically, f~up~ is the ratio of the buffer side response to the plasma side responses. To account for background noise and variation, we subtract the corresponding blank sample from the mean response. 

PBS Response (Phosphate-buffered solution) - NPB Response (No.Plasma.Blank)
-------------------------------------------------------------
PL Response (Plasma) - B Response (Plasma.Blank)
